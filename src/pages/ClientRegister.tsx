...
const ClientRegister = () => {
  ...
  const inputClass =
    "w-full rounded-lg border border-border bg-secondary/50 px-4 py-3 text-sm text-foreground placeholder-muted-foreground focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 transition-colors";
        ...
        <div className="container mx-auto max-w-3xl px-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h3 className="text-lg font-display font-semibold mb-5">Company Details</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div><label className={labelClass}>Company Size *</label><input required className={inputClass} value={form.companySize} onChange={handleChange("companySize")} placeholder="e.g. 201-500 Employees" /></div>
                <div className="md:col-span-2"><label className={labelClass}>Company Type *</label><input required className={inputClass} value={form.companyType} onChange={handleChange("companyType")} /></div>
              </div>
            </div>

            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h3 className="text-lg font-display font-semibold mb-5">SPOC / Hiring Contact</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div><label className={labelClass}>Mobile *</label><input required className={inputClass} value={form.mobile} onChange={handleChange("mobile")} maxLength={10} /></div>
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h3 className="text-lg font-display font-semibold mb-5">Job Requirement Details</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div><label className={labelClass}>Employment Type *</label><input required className={inputClass} value={form.employmentType} onChange={handleChange("employmentType")} /></div>
                <div><label className={labelClass}>Experience Required *</label><input required className={inputClass} value={form.experienceRequired} onChange={handleChange("experienceRequired")} /></div>
                <div><label className={labelClass}>Min CTC (LPA) *</label><input required type="number" className={inputClass} value={form.minCtcLpa} onChange={handleChange("minCtcLpa")} /></div>
                <div><label className={labelClass}>Max CTC (LPA) *</label><input required type="number" className={inputClass} value={form.maxCtcLpa} onChange={handleChange("maxCtcLpa")} /></div>
                <div><label className={labelClass}>Preferred Industry</label><input className={inputClass} value={form.preferredIndustryBackground} onChange={handleChange("preferredIndustryBackground")} /></div>
                <div><label className={labelClass}>Gender Preference</label><input className={inputClass} value={form.genderPreference} onChange={handleChange("genderPreference")} placeholder="No Preference" /></div>
                <div><label className={labelClass}>Urgency Level *</label><input required className={inputClass} value={form.urgencyLevel} onChange={handleChange("urgencyLevel")} placeholder="Immediate / 15 Days / 30 Days" /></div>
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h3 className="text-lg font-display font-semibold mb-5">Commercial + Billing</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><label className={labelClass}>Recruitment Model *</label><input required className={inputClass} value={form.recruitmentModel} onChange={handleChange("recruitmentModel")} /></div>
                <div><label className={labelClass}>Replacement Period *</label><input required className={inputClass} value={form.replacementPeriod} onChange={handleChange("replacementPeriod")} /></div>
                <div className="md:col-span-2"><label className={labelClass}>Payment Terms *</label><input required className={inputClass} value={form.paymentTerms} onChange={handleChange("paymentTerms")} /></div>
                ...
                <div><label className={labelClass}>GST Number *</label><input required className={inputClass} value={form.gstNumber} onChange={handleChange("gstNumber")} maxLength={15} /></div>
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h3 className="text-lg font-display font-semibold mb-5">Create Password</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm font-medium">I confirm the information is accurate and agree to engage ANAAGAT HUMANPOWER PRIVATE LIMITED.</span>
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full rounded-xl py-4 text-base font-bold text-white transition-all hover:scale-[1.02] hover:shadow-2xl disabled:opacity-60"
